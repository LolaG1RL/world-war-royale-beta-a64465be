...
const translations: TranslationMap = {
  ...
  // ═══ Additional Social / Clan Chat ═══
  'social.post_trade': { en: 'Post Trade Request', es: 'Publicar Intercambio', fr: "Publier une Demande d'Échange", de: 'Tauschgesuch posten', pt: 'Publicar Troca', ja: 'トレードリクエスト投稿', ko: '교환 요청 게시', zh: '发布交易请求', ar: 'نشر طلب تبادل', ru: 'Запрос на обмен' },
  'social.you_offer': { en: 'You Offer', es: 'Ofreces', fr: 'Vous Offrez', de: 'Du bietest', pt: 'Você Oferece', ja: '提供', ko: '제공', zh: '你提供', ar: 'تعرض', ru: 'Вы предлагаете' },
  'social.you_want': { en: 'You Want', es: 'Quieres', fr: 'Vous Voulez', de: 'Du willst', pt: 'Você Quer', ja: '希望', ko: '원하는', zh: '你想要', ar: 'تريد', ru: 'Вы хотите' },
  'social.select_card': { en: 'Select card...', es: 'Seleccionar carta...', fr: 'Choisir une carte...', de: 'Karte wählen...', pt: 'Selecionar carta...', ja: 'カードを選択...', ko: '카드 선택...', zh: '选择卡牌...', ar: 'اختر بطاقة...', ru: 'Выберите карту...' },
  'social.cant_trade_self': { en: "Can't trade a card for itself!", es: '¡No puedes intercambiar una carta por sí misma!', fr: "Impossible d'échanger une carte contre elle-même!", de: 'Kann eine Karte nicht gegen sich selbst tauschen!', pt: 'Não pode trocar uma carta por ela mesma!', ja: '同じカードでは交換できません！', ko: '같은 카드끼리 교환할 수 없습니다!', zh: '不能用同一张卡交换！', ar: 'لا يمكن تبادل بطاقة بنفسها!', ru: 'Нельзя обменять карту на саму себя!' },
  'social.post_trade_btn': { en: 'Post Trade', es: 'Publicar', fr: "Publier l'Échange", de: 'Tausch posten', pt: 'Publicar', ja: 'トレード投稿', ko: '교환 게시', zh: '发布交易', ar: 'نشر التبادل', ru: 'Опубликовать обмен' },
  'social.request_card': { en: 'Request a Card', es: 'Solicitar una Carta', fr: 'Demander une Carte', de: 'Karte anfordern', pt: 'Solicitar uma Carta', ja: 'カードをリクエスト', ko: '카드 요청', zh: '请求卡牌', ar: 'طلب بطاقة', ru: 'Запросить карту' },
  'social.card_to_request': { en: 'Card to Request', es: 'Carta a Solicitar', fr: 'Carte à Demander', de: 'Anzufordernde Karte', pt: 'Carta a Solicitar', ja: 'リクエストするカード', ko: '요청할 카드', zh: '要请求的卡牌', ar: 'البطاقة المطلوبة', ru: 'Запрашиваемая карта' },
  'social.max_donations': { en: 'Max donations/day', es: 'Máx. donaciones/día', fr: 'Dons max/jour', de: 'Max. Spenden/Tag', pt: 'Máx. doações/dia', ja: '1日の最大寄付', ko: '일일 최대 기부', zh: '每日最大捐赠', ar: 'أقصى تبرعات/يوم', ru: 'Макс. пожертвований/день' },
  'social.cooldown_between': { en: '8h cooldown between requests', es: '8h de espera entre solicitudes', fr: '8h entre les demandes', de: '8h Abklingzeit', pt: '8h entre solicitações', ja: 'リクエスト間8時間', ko: '요청 사이 8시간', zh: '请求间隔8小时', ar: '8 ساعات بين الطلبات', ru: '8ч между запросами' },
  'social.request_card_btn': { en: 'Request Card', es: 'Solicitar Carta', fr: 'Demander la Carte', de: 'Karte anfordern', pt: 'Solicitar Carta', ja: 'カードをリクエスト', ko: '카드 요청', zh: '请求卡牌', ar: 'طلب البطاقة', ru: 'Запросить карту' },
  'social.skip_cost': { en: 'Skip', es: 'Saltar', fr: 'Passer', de: 'Überspringen', pt: 'Pular', ja: 'スキップ', ko: '건너뛰기', zh: '跳过', ar: 'تخطي', ru: 'Пропустить' },
  'social.accept_trade': { en: 'Accept Trade', es: 'Aceptar Intercambio', fr: "Accepter l'Échange", de: 'Tausch akzeptieren', pt: 'Aceitar Troca', ja: 'トレードを承認', ko: '교환 수락', zh: '接受交易', ar: 'قبول التبادل', ru: 'Принять обмен' },
  'social.no_messages': { en: 'No messages yet — say hello!', es: '¡Sin mensajes aún — di hola!', fr: 'Pas de messages — dites bonjour!', de: 'Noch keine Nachrichten — sag hallo!', pt: 'Sem mensagens — diga olá!', ja: 'まだメッセージなし — 挨拶しよう！', ko: '메시지가 없습니다 — 인사하세요!', zh: '还没有消息——打个招呼吧！', ar: 'لا رسائل بعد — قل مرحباً!', ru: 'Пока нет сообщений — поздоровайтесь!' },
  'social.no_emotes_equipped': { en: 'No emotes equipped — equip in Cards → Emotes', es: 'Sin emotes — equipa en Cartas → Emotes', fr: 'Aucun emote — équipez dans Cartes → Emotes', de: 'Keine Emotes — in Karten → Emotes ausrüsten', pt: 'Sem emotes — equipe em Cartas → Emotes', ja: 'エモート未装備 — カード→エモートで装備', ko: '이모트 없음 — 카드 → 이모트에서 장착', zh: '未装备表情 — 在卡牌→表情中装备', ar: 'لا تعبيرات — جهّز من البطاقات → التعبيرات', ru: 'Нет эмоций — экипируйте в Карты → Эмоции' },
  'social.type_message': { en: 'Type a message...', es: 'Escribe un mensaje...', fr: 'Tapez un message...', de: 'Nachricht eingeben...', pt: 'Digite uma mensagem...', ja: 'メッセージを入力...', ko: '메시지 입력...', zh: '输入消息...', ar: 'اكتب رسالة...', ru: 'Введите сообщение...' },
