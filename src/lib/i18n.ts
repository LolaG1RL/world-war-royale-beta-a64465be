...
const translations: TranslationMap = {
  ...
  'battle.training_day': { en: '🏋️ Training Day — No medals awarded', es: '🏋️ Día de entrenamiento — Sin medallas', fr: '🏋️ Jour d\'entraînement — Pas de médailles', de: '🏋️ Trainingstag — Keine Medaillen', pt: '🏋️ Dia de treino — Sem medalhas', ja: '🏋️ トレーニングデー — メダルなし', ko: '🏋️ 훈련일 — 메달 없음', zh: '🏋️ 训练日 — 无奖牌', ar: '🏋️ يوم تدريب — بدون ميداليات', ru: '🏋️ Тренировочный день — Без медалей' },
  'battle.boat_battle_label': { en: 'BOAT BATTLE', es: 'BATALLA NAVAL', fr: 'COMBAT NAVAL', de: 'BOOTKAMPF', pt: 'BATALHA NAVAL', ja: 'ボートバトル', ko: '보트 전투', zh: '船战', ar: 'معركة بحرية', ru: 'МОРСКОЙ БОЙ' },
};
