...
const translations: TranslationMap = {
  ...
  'cards.avg_elixir': { en: 'Avg Elixir', es: 'Elixir Prom.', fr: 'Élixir Moy.', de: 'Durchschn. Elixier', pt: 'Elixir Méd.', ja: '平均エリクサー', ko: '평균 엘릭서', zh: '平均圣水', ar: 'متوسط الإكسير', ru: 'Ср. эликсир' },
  'cards.hero_slots': { en: 'Hero Slots', es: 'Ranuras Héroe', fr: 'Emplacements Héros', de: 'Helden-Slots', pt: 'Slots de Herói', ja: 'ヒーロースロット', ko: '영웅 슬롯', zh: '英雄槽位', ar: 'فتحات الأبطال', ru: 'Слоты героев' },
  'cards.card_info': { en: 'Card Info', es: 'Info de Carta', fr: 'Info Carte', de: 'Karteninfo', pt: 'Info da Carta', ja: 'カード情報', ko: '카드 정보', zh: '卡牌信息', ar: 'معلومات البطاقة', ru: 'Инфо о карте' },
  'cards.level': { en: 'Level', es: 'Nivel', fr: 'Niveau', de: 'Stufe', pt: 'Nível', ja: 'レベル', ko: '레벨', zh: '等级', ar: 'المستوى', ru: 'Уровень' },
  'cards.win_condition': { en: 'WIN CONDITION', es: 'CONDICIÓN DE VICTORIA', fr: 'CONDITION DE VICTOIRE', de: 'SIEGBEDINGUNG', pt: 'CONDIÇÃO DE VITÓRIA', ja: '勝利条件', ko: '승리 조건', zh: '胜利条件', ar: 'شرط الفوز', ru: 'УСЛОВИЕ ПОБЕДЫ' },
  'cards.locked': { en: '🔒 LOCKED', es: '🔒 BLOQUEADO', fr: '🔒 VERROUILLÉ', de: '🔒 GESPERRT', pt: '🔒 BLOQUEADO', ja: '🔒 ロック中', ko: '🔒 잠김', zh: '🔒 已锁定', ar: '🔒 مقفل', ru: '🔒 ЗАБЛОКИРОВАНО' },
  'cards.card_level_progress': { en: 'Card Level Progress', es: 'Progreso de Nivel', fr: 'Progression de Niveau', de: 'Kartenfortschritt', pt: 'Progresso de Nível', ja: 'レベル進捗', ko: '레벨 진행도', zh: '卡牌等级进度', ar: 'تقدم المستوى', ru: 'Прогресс уровня' },
  ...
  'cards.add_to_deck': { en: 'Add to Deck', es: 'Añadir al Mazo', fr: 'Ajouter au Deck', de: 'Zum Deck hinzufügen', pt: 'Adicionar ao Deck', ja: 'デッキに追加', ko: '덱에 추가', zh: '加入卡组', ar: 'إضافة للمجموعة', ru: 'Добавить в колоду' },
  ...
  'cards.overview': { en: 'Overview', es: 'Resumen', fr: 'Aperçu', de: 'Übersicht', pt: 'Visão Geral', ja: '概要', ko: '개요', zh: '概览', ar: 'نظرة عامة', ru: 'Обзор' },
  'cards.matchup': { en: 'Matchup', es: 'Matchup', fr: 'Matchup', de: 'Matchup', pt: 'Matchup', ja: 'マッチアップ', ko: '상성', zh: '对局', ar: 'المواجهة', ru: 'Матчап' },
  'cards.cards_count': { en: 'cards', es: 'cartas', fr: 'cartes', de: 'Karten', pt: 'cartas', ja: 'カード', ko: '카드', zh: '卡牌', ar: 'بطاقات', ru: 'карт' },
  'cards.arena': { en: 'Arena', es: 'Arena', fr: 'Arène', de: 'Arena', pt: 'Arena', ja: 'アリーナ', ko: '아레나', zh: '竞技场', ar: 'الحلبة', ru: 'Арена' },
  'cards.hero': { en: 'HERO', es: 'HÉROE', fr: 'HÉROS', de: 'HELD', pt: 'HERÓI', ja: 'ヒーロー', ko: '영웅', zh: '英雄', ar: 'بطل', ru: 'ГЕРОЙ' },
  'cards.all': { en: 'all', es: 'todos', fr: 'tous', de: 'alle', pt: 'todos', ja: 'すべて', ko: '전체', zh: '全部', ar: 'الكل', ru: 'все' },
  'cards.troop': { en: 'troop', es: 'tropa', fr: 'troupe', de: 'truppe', pt: 'tropa', ja: 'ユニット', ko: '유닛', zh: '部队', ar: 'جندي', ru: 'отряд' },
  'cards.spell': { en: 'spell', es: 'hechizo', fr: 'sort', de: 'zauber', pt: 'feitiço', ja: '呪文', ko: '주문', zh: '法术', ar: 'تعويذة', ru: 'заклинание' },
  'cards.building': { en: 'building', es: 'edificio', fr: 'bâtiment', de: 'gebäude', pt: 'construção', ja: '建物', ko: '건물', zh: '建筑', ar: 'مبنى', ru: 'здание' },
