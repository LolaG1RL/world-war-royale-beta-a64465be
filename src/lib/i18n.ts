...
const translations: TranslationMap = {
  ...
  'social.friendly_battle': { en: 'Battle', es: 'Batalla', fr: 'Combat', de: 'Kampf', pt: 'Batalha', ja: 'バトル', ko: '배틀', zh: '战斗', ar: 'معركة', ru: 'Битва' },
  'battle.deck_not_full': { en: 'Your deck needs exactly 8 cards!', es: '¡Tu mazo necesita exactamente 8 cartas!', fr: 'Votre deck doit contenir exactement 8 cartes!', de: 'Dein Deck braucht genau 8 Karten!', pt: 'Seu deck precisa de exatamente 8 cartas!', ja: 'デッキには8枚のカードが必要です！', ko: '덱에 정확히 8장의 카드가 필요합니다!', zh: '你的卡组需要正好8张卡！', ar: 'مجموعتك تحتاج 8 بطاقات بالضبط!', ru: 'В колоде должно быть ровно 8 карт!' },
  ...
  'social.inappropriate_content': { en: 'Inappropriate content detected!', es: '¡Contenido inapropiado detectado!', fr: 'Contenu inapproprié détecté!', de: 'Unangemessener Inhalt erkannt!', pt: 'Conteúdo inapropriado detectado!', ja: '不適切なコンテンツが検出されました！', ko: '부적절한 콘텐츠가 감지되었습니다!', zh: '检测到不当内容！', ar: 'تم اكتشاف محتوى غير لائق!', ru: 'Обнаружен неприемлемый контент!' },
  'social.season_ends': { en: 'Season ends in', es: 'Temporada termina en', fr: 'Saison se termine dans', de: 'Saison endet in', pt: 'Temporada termina em', ja: 'シーズン終了まで', ko: '시즌 종료까지', zh: '赛季结束倒计时', ar: 'ينتهي الموسم في', ru: 'Сезон заканчивается через' },
  'social.friendly_battle': { en: 'Battle', es: 'Batalla', fr: 'Combat', de: 'Kampf', pt: 'Batalha', ja: 'バトル', ko: '전투', zh: '战斗', ar: 'معركة', ru: 'Бой' },
  'battle.deck_not_full': { en: 'Your deck must have 8 cards!', es: '¡Tu mazo debe tener 8 cartas!', fr: 'Votre deck doit avoir 8 cartes!', de: 'Dein Deck muss 8 Karten haben!', pt: 'Seu deck deve ter 8 cartas!', ja: 'デッキには8枚のカードが必要です！', ko: '덱에 8장의 카드가 필요합니다!', zh: '你的卡组必须有8张卡牌！', ar: 'مجموعتك يجب أن تحتوي على 8 بطاقات!', ru: 'В вашей колоде должно быть 8 карт!' },
  'battle.deck_incomplete': { en: 'Complete your deck (8 cards) before battling!', es: '¡Completa tu mazo (8 cartas) antes de la batalla!', fr: 'Complétez votre deck (8 cartes) avant le combat!', de: 'Vervollständige dein Deck (8 Karten) vor dem Kampf!', pt: 'Complete seu deck (8 cartas) antes de batalhar!', ja: 'バトル前にデッキを完成させてください（8枚）！', ko: '전투 전에 덱을 완성하세요 (8장)!', zh: '战斗前请完成你的卡组（8张卡牌）！', ar: 'أكمل مجموعتك (8 بطاقات) قبل المعركة!', ru: 'Соберите колоду (8 карт) перед боем!' },
