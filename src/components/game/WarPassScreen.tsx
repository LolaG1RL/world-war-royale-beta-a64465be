...
const WAR_PASS_REWARDS: PassReward[] = [
  ...
  { tier: 2, crownsNeeded: 5, free: { type: 'cards', amount: 2, emoji: '🃏', label: '2 Cards' }, paid: { type: 'gold', amount: 300, emoji: '💰', label: '300 Gold' } },
  { tier: 3, crownsNeeded: 8, free: { type: 'gold', amount: 200, emoji: '💰', label: '200 Gold' }, paid: { type: 'chest', amount: 1, emoji: '🪙', label: 'Silver Chest' } },
  { tier: 4, crownsNeeded: 11, free: { type: 'gems', amount: 3, emoji: '💎', label: '3 Gems' }, paid: { type: 'gold', amount: 500, emoji: '💰', label: '500 Gold' } },
  { tier: 5, crownsNeeded: 15, free: { type: 'gold', amount: 400, emoji: '💰', label: '400 Gold' }, paid: { type: 'gems', amount: 10, emoji: '💎', label: '10 Gems' } },
  { tier: 6, crownsNeeded: 19, free: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Cards' }, paid: { type: 'chest', amount: 1, emoji: '💰', label: 'Gold Chest' } },
  { tier: 7, crownsNeeded: 23, free: { type: 'chest', amount: 1, emoji: '🪙', label: 'Silver Chest' }, paid: { type: 'gold', amount: 1000, emoji: '💰', label: '1K Gold' } },
  { tier: 8, crownsNeeded: 28, free: { type: 'gold', amount: 600, emoji: '💰', label: '600 Gold' }, paid: { type: 'gems', amount: 15, emoji: '💎', label: '15 Gems' } },
  { tier: 9, crownsNeeded: 33, free: { type: 'gems', amount: 5, emoji: '💎', label: '5 Gems' }, paid: { type: 'cards', amount: 5, emoji: '🃏', label: '5 Rare Cards' } },
  { tier: 10, crownsNeeded: 38, free: { type: 'gold', amount: 800, emoji: '💰', label: '800 Gold' }, paid: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' } },
  { tier: 11, crownsNeeded: 43, free: { type: 'cards', amount: 4, emoji: '🃏', label: '4 Cards' }, paid: { type: 'gold', amount: 1500, emoji: '💰', label: '1.5K Gold' } },
  { tier: 12, crownsNeeded: 49, free: { type: 'chest', amount: 1, emoji: '💰', label: 'Gold Chest' }, paid: { type: 'gems', amount: 25, emoji: '💎', label: '25 Gems' } },
  { tier: 13, crownsNeeded: 55, free: { type: 'gold', amount: 1000, emoji: '💰', label: '1K Gold' }, paid: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Epic Cards' } },
  { tier: 14, crownsNeeded: 61, free: { type: 'gems', amount: 8, emoji: '💎', label: '8 Gems' }, paid: { type: 'gold', amount: 2000, emoji: '💰', label: '2K Gold' } },
  { tier: 15, crownsNeeded: 68, free: { type: 'gold', amount: 1500, emoji: '💰', label: '1.5K Gold' }, paid: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' } },
  { tier: 16, crownsNeeded: 75, free: { type: 'cards', amount: 5, emoji: '🃏', label: '5 Cards' }, paid: { type: 'gems', amount: 35, emoji: '💎', label: '35 Gems' } },
  ...
  { tier: 20, crownsNeeded: 106, free: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' }, paid: { type: 'emote', amount: 1, emoji: '🎭', label: 'Exclusive Emote' } },
  { tier: 21, crownsNeeded: 114, free: { type: 'gold', amount: 2500, emoji: '💰', label: '2.5K Gold' }, paid: { type: 'gems', amount: 60, emoji: '💎', label: '60 Gems' } },
  { tier: 22, crownsNeeded: 122, free: { type: 'gems', amount: 12, emoji: '💎', label: '12 Gems' }, paid: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' } },
  { tier: 23, crownsNeeded: 131, free: { type: 'cards', amount: 6, emoji: '🃏', label: '6 Cards' }, paid: { type: 'gold', amount: 4000, emoji: '💰', label: '4K Gold' } },
  { tier: 24, crownsNeeded: 140, free: { type: 'chest', amount: 1, emoji: '💰', label: 'Gold Chest' }, paid: { type: 'gems', amount: 75, emoji: '💎', label: '75 Gems' } },
  { tier: 25, crownsNeeded: 149, free: { type: 'gold', amount: 3000, emoji: '💰', label: '3K Gold' }, paid: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Epic Cards' } },
  { tier: 26, crownsNeeded: 158, free: { type: 'gems', amount: 15, emoji: '💎', label: '15 Gems' }, paid: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' } },
  { tier: 27, crownsNeeded: 168, free: { type: 'cards', amount: 4, emoji: '🃏', label: '4 Rare Cards' }, paid: { type: 'gold', amount: 5000, emoji: '💰', label: '5K Gold' } },
  { tier: 28, crownsNeeded: 178, free: { type: 'gold', amount: 4000, emoji: '💰', label: '4K Gold' }, paid: { type: 'gems', amount: 100, emoji: '💎', label: '100 Gems' } },
  { tier: 29, crownsNeeded: 188, free: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' }, paid: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Legendary' } },
  { tier: 30, crownsNeeded: 198, free: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' }, paid: { type: 'emote', amount: 1, emoji: '👑', label: 'Champion Emote' } },
  // ── Extended tiers 31–60 ──
  { tier: 31, crownsNeeded: 204, free: { type: 'gold', amount: 3000, emoji: '💰', label: '3K Gold' }, paid: { type: 'gems', amount: 40, emoji: '💎', label: '40 Gems' } },
  { tier: 32, crownsNeeded: 210, free: { type: 'cards', amount: 5, emoji: '🃏', label: '5 Cards' }, paid: { type: 'gold', amount: 4000, emoji: '💰', label: '4K Gold' } },
  { tier: 33, crownsNeeded: 216, free: { type: 'gems', amount: 12, emoji: '💎', label: '12 Gems' }, paid: { type: 'chest', amount: 1, emoji: '💰', label: 'Gold Chest' } },
  { tier: 34, crownsNeeded: 222, free: { type: 'gold', amount: 3500, emoji: '💰', label: '3.5K Gold' }, paid: { type: 'gems', amount: 50, emoji: '💎', label: '50 Gems' } },
  { tier: 35, crownsNeeded: 228, free: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' }, paid: { type: 'gold', amount: 5000, emoji: '💰', label: '5K Gold' } },
  { tier: 36, crownsNeeded: 234, free: { type: 'cards', amount: 4, emoji: '🃏', label: '4 Rare Cards' }, paid: { type: 'gems', amount: 60, emoji: '💎', label: '60 Gems' } },
  { tier: 37, crownsNeeded: 240, free: { type: 'gold', amount: 4000, emoji: '💰', label: '4K Gold' }, paid: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' } },
  { tier: 38, crownsNeeded: 246, free: { type: 'gems', amount: 15, emoji: '💎', label: '15 Gems' }, paid: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Epic Cards' } },
  { tier: 39, crownsNeeded: 252, free: { type: 'chest', amount: 1, emoji: '💰', label: 'Gold Chest' }, paid: { type: 'gold', amount: 6000, emoji: '💰', label: '6K Gold' } },
  { tier: 40, crownsNeeded: 258, free: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' }, paid: { type: 'gems', amount: 80, emoji: '💎', label: '80 Gems' } },
  { tier: 41, crownsNeeded: 262, free: { type: 'gold', amount: 5000, emoji: '💰', label: '5K Gold' }, paid: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' } },
  { tier: 42, crownsNeeded: 266, free: { type: 'cards', amount: 6, emoji: '🃏', label: '6 Cards' }, paid: { type: 'gold', amount: 7000, emoji: '💰', label: '7K Gold' } },
  { tier: 43, crownsNeeded: 270, free: { type: 'gems', amount: 18, emoji: '💎', label: '18 Gems' }, paid: { type: 'gems', amount: 90, emoji: '💎', label: '90 Gems' } },
  { tier: 44, crownsNeeded: 274, free: { type: 'gold', amount: 5500, emoji: '💰', label: '5.5K Gold' }, paid: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Legendary' } },
  { tier: 45, crownsNeeded: 278, free: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' }, paid: { type: 'gold', amount: 8000, emoji: '💰', label: '8K Gold' } },
  { tier: 46, crownsNeeded: 281, free: { type: 'cards', amount: 5, emoji: '🃏', label: '5 Rare Cards' }, paid: { type: 'gems', amount: 100, emoji: '💎', label: '100 Gems' } },
  { tier: 47, crownsNeeded: 284, free: { type: 'gold', amount: 6000, emoji: '💰', label: '6K Gold' }, paid: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' } },
  { tier: 48, crownsNeeded: 287, free: { type: 'gems', amount: 20, emoji: '💎', label: '20 Gems' }, paid: { type: 'gold', amount: 10000, emoji: '💰', label: '10K Gold' } },
  { tier: 49, crownsNeeded: 290, free: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' }, paid: { type: 'gems', amount: 120, emoji: '💎', label: '120 Gems' } },
  // ★ Tier 50 Pass+ = Season Exclusive Emote
  { tier: 50, crownsNeeded: 293, free: { type: 'gold', amount: 8000, emoji: '💰', label: '8K Gold' }, paid: { type: 'season-emote', amount: 1, emoji: '🎭', label: 'S1 Emote' } },
  { tier: 51, crownsNeeded: 295, free: { type: 'gems', amount: 25, emoji: '💎', label: '25 Gems' }, paid: { type: 'gold', amount: 12000, emoji: '💰', label: '12K Gold' } },
  { tier: 52, crownsNeeded: 296, free: { type: 'cards', amount: 4, emoji: '🃏', label: '4 Epic Cards' }, paid: { type: 'gems', amount: 130, emoji: '💎', label: '130 Gems' } },
  { tier: 53, crownsNeeded: 297, free: { type: 'gold', amount: 9000, emoji: '💰', label: '9K Gold' }, paid: { type: 'chest', amount: 1, emoji: '⚡', label: 'Lightning Chest' } },
  { tier: 54, crownsNeeded: 298, free: { type: 'chest', amount: 1, emoji: '✨', label: 'Magic Chest' }, paid: { type: 'gold', amount: 15000, emoji: '💰', label: '15K Gold' } },
  // ★ Tier 55 Pass+ = 2 Season Exclusive Animated Banner Parts
  { tier: 55, crownsNeeded: 299, free: { type: 'gems', amount: 30, emoji: '💎', label: '30 Gems' }, paid: { type: 'season-banner', amount: 2, emoji: '🎨', label: 'S1 Banner Set' } },
  { tier: 56, crownsNeeded: 299, free: { type: 'gold', amount: 10000, emoji: '💰', label: '10K Gold' }, paid: { type: 'gems', amount: 150, emoji: '💎', label: '150 Gems' } },
  { tier: 57, crownsNeeded: 299, free: { type: 'cards', amount: 3, emoji: '🃏', label: '3 Legendary' }, paid: { type: 'gold', amount: 18000, emoji: '💰', label: '18K Gold' } },
  { tier: 58, crownsNeeded: 300, free: { type: 'gems', amount: 35, emoji: '💎', label: '35 Gems' }, paid: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' } },
  { tier: 59, crownsNeeded: 300, free: { type: 'chest', amount: 1, emoji: '👑', label: 'Legendary Chest' }, paid: { type: 'gems', amount: 200, emoji: '💎', label: '200 Gems' } },
  // ★ Tier 60 Pass+ = Season Exclusive Champion (always active)
  { tier: 60, crownsNeeded: 300, free: { type: 'gold', amount: 15000, emoji: '💰', label: '15K Gold' }, paid: { type: 'season-hero', amount: 1, emoji: '👑', label: 'Joan of Arc' } },
];
